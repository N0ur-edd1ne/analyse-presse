            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    ...
                    <div style="background-color: whitesmoke; text-align :center;">
                        <h1>Modification des détails de l'Etude</h1>
                    </div>
                    ...
                    <form action="{{ route('etudes.update', $etude->id) }}" method="POST">
                        ...
                        <div class="pd-20 bg-white border-radius-4 box-shadow mb-0">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="name">Numéro de l'Etude</label>
                                    <input type="text" name="numerotationE" class="form-control" value="{{ $etude->numerotationE }}" />
                                    @error('numerotationE')
                                ...
                                <div class="form-group">
                                    <label for="name">Idientifiant de l'Etude</label>
                                    <input type="text" name="idInputE" class="form-control" value="{{ $etude->idInputE }}" />
                                    @error('idInputE')
                                    <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="name">Libellé de l'Etude</label>
                                    <input type="text" name="libelleE" class="form-control" value="{{ $etude->libelleE }}" />
                                    @error('libelleE')
                                    <span class="text-danger"> {{ $message }} </span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="etudeAssocieeE" id="etudeAssocieeE" class="form-control" value="{{ $etude->etudeAssocieeE }}">
