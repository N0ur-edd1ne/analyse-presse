            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    ...
                    <div style="background-color: whitesmoke; text-align :center;">
                        <h1>Affichage des détails de l'Etude</h1>
                    </div>
                    ...
                    <div style="margin-left: 50px; margin-right: 50px;">
                        <table style="width: 100%; text-align: center; border-collapse: collapse;">
                            <thead>
                                <tr>
                                    <th style="font-weight: bold; border: 1px solid black;">Numérotation</th>
                                    <th style="font-weight: bold; border: 1px solid black;">Identifiant de l'Etude</th>
                                    <th style="font-weight: bold; border: 1px solid black;">Libellé de l'Etude</th>
                                    <th style="font-weight: bold; border: 1px solid black;">Etudes Associées</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td style="border: 1px solid black;">{{ $etude->numerotationE }}</td>
                                    <td style="border: 1px solid black;">{{ $etude->idInputE }}</td>
                                    <td style="border: 1px solid black;">{{ $etude->libelleE }}</td>
                                    <td style="border: 1px solid black;">{{ $etude->etudeAssocieeE }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
