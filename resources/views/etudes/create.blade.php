                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('etudes.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="numerotationE" class="form-control" />
                            @error('numerotationE')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="idInputE" class="form-control" />
                            @error('idInputE')
                            <span class="text-danger"> {{ $message }} </span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="etudeAssocieeE" id="etudeAssocieeE" class="form-control">
