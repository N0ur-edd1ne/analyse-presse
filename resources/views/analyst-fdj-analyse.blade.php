			...
			<main class="content px-3 py-4">
				<div class="container-fluid">
					...
					<div style="background-color: whitesmoke; text-align :center;">
						<h1>Grille d'analyse FDJ</h1>
					</div>

					<br>

					<form method="POST" action="{{ route('store_fdj', ['id' => $nextId ?? $fdj->id]) }}" enctype="multipart/form-data">
						@csrf
						@method('PUT')
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="accordion">
											...
											<div class="accordion-content">
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck1" name="themeAbordes[]" value="1" />
													<label class="custom-control-label" for="customCheck1">1. Actualités économiques</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck2" name="themeAbordes[]" value="2" />
													<label class="custom-control-label" for="customCheck2">2. Actualités corporate</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck3" name="themeAbordes[]" value="3" />
													<label class="custom-control-label" for="customCheck3">3. IPO</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck4" name="themeAbordes[]" value="4" />
													<label class="custom-control-label" for="customCheck4">4. Jeu responsable</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck5" name="themeAbordes[]" value="5" />
													<label class="custom-control-label" for="customCheck5">5. Fondation FDJ</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck6" name="themeAbordes[]" value="6" />
													<label class="custom-control-label" for="customCheck6">6. Mixité parité</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck7" name="themeAbordes[]" value="7" />
													<label class="custom-control-label" for="customCheck7">7. Autre sujet RSE</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck8" name="themeAbordes[]" value="8" />
													<label class="custom-control-label" for="customCheck8">8. Equipes cyclistes</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck9" name="themeAbordes[]" value="9" />
													<label class="custom-control-label" for="customCheck9">9. Autres investissements dans le sport, dont Paris 2024</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck10" name="themeAbordes[]" value="10" />
													<label class="custom-control-label" for="customCheck10">10. Le sport au féminin</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck11" name="themeAbordes[]" value="11" />
													<label class="custom-control-label" for="customCheck11">11. E-sport</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck12" name="themeAbordes[]" value="12" />
													<label class="custom-control-label" for="customCheck12">12. Autre sujet sportif</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck13" name="themeAbordes[]" value="13" />
													<label class="custom-control-label" for="customCheck13">13. Jeux de tirage et de grattage</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck14" name="themeAbordes[]" value="14" />
													<label class="custom-control-label" for="customCheck14">14. Application FDJ</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck15" name="themeAbordes[]" value="15" />
													<label class="custom-control-label" for="customCheck15">15. Jeux excessifs/addiction</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck16" name="themeAbordes[]" value="16" />
													<label class="custom-control-label" for="customCheck16">16. Jeux des mineurs</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck17" name="themeAbordes[]" value="17" />
													<label class="custom-control-label" for="customCheck17">17. Pression publicitaire</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck18" name="themeAbordes[]" value="18" />
													<label class="custom-control-label" for="customCheck18">18. Sponsoring Ligue Française de Football</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck19" name="themeAbordes[]" value="19" />
													<label class="custom-control-label" for="customCheck19">19. Gagnants</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck20" name="themeAbordes[]" value="20" />
									...
									<div class="col-md-6 col-sm-12">
										<div class="accordion">
											...
											<div class="accordion-content">
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck21" name="angleRetombee[]" value="1" />
													<label class="custom-control-label" for="customCheck21">1. Corporate</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck22" name="angleRetombee[]" value="2" />
													<label class="custom-control-label" for="customCheck22">2. Sport</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck23" name="angleRetombee[]" value="3" />
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="accordion">
											...
											<div class="accordion-content">
												<div>
													<input type="radio" id="customRadio33" name="tonaliteRetombees" class="custom-control-input" value="1/" />
													<label class="custom-control-label" for="customRadio33">1. Positive</label>
												</div>
												<div>
													<input type="radio" id="customRadio34" name="tonaliteRetombees" class="custom-control-input" value="2/" />
													<label class="custom-control-label" for="customRadio34">2. Neutre</label>
												</div>
												<div>
													<input type="radio" id="customRadio35" name="tonaliteRetombees" class="custom-control-input" value="3/" />
													<label class="custom-control-label" for="customRadio35">3. Mitigée</label>
												</div>
												<div>
													<input type="radio" id="customRadio36" name="tonaliteRetombees" class="custom-control-input" value="4/" />
									...
									<div class="col-md-6 col-sm-12">
										<div class="accordion">
											...
											<div class="accordion-content">
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck24" name="attributImage[]" value="1" />
													<label class="custom-control-label" for="customCheck24">1. Aucun</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck25" name="attributImage[]" value="2" />
													<label class="custom-control-label" for="customCheck25">2. Performante économiquement et financièrement</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck26" name="attributImage[]" value="3" />
													<label class="custom-control-label" for="customCheck26">3. Reponsable</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck27" name="attributImage[]" value="4" />
													<label class="custom-control-label" for="customCheck27">4. Engagée</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck28" name="attributImage[]" value="5" />
													<label class="custom-control-label" for="customCheck28">5. Innovante</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck29" name="attributImage[]" value="6" />
													<label class="custom-control-label" for="customCheck29">6. Proche des gens</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck30" name="attributImage[]" value="7" />
													<label class="custom-control-label" for="customCheck30">7. Optimiste</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck31" name="attributImage[]" value="8" />
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="accordion">
											...
											<div class="accordion-content">
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck32" name="discoursGroupe[]" value="1" />
													<label class="custom-control-label" for="customCheck32">1. Aucun</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck33" name="discoursGroupe[]" value="2" />
													<label class="custom-control-label" for="customCheck33">2. Stéphane PALLEZ</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck34" name="discoursGroupe[]" value="3" />
													<label class="custom-control-label" for="customCheck34">3. Isabelle CESARI</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck35" name="discoursGroupe[]" value="4" />
													<label class="custom-control-label" for="customCheck35">4. Pierre-Marie ARGOUARC'H</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck36" name="discoursGroupe[]" value="5" />
													<label class="custom-control-label" for="customCheck36">5. Patrick BUFFARD</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck37" name="discoursGroupe[]" value="6" />
													<label class="custom-control-label" for="customCheck37">6. Pascal CHAFFARD</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck38" name="discoursGroupe[]" value="7" />
													<label class="custom-control-label" for="customCheck38">7. Charles LANTIERI</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck39" name="discoursGroupe[]" value="8" />
													<label class="custom-control-label" for="customCheck39">8. Cécile LAGE</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck40" name="discoursGroupe[]" value="9" />
													<label class="custom-control-label" for="customCheck40">9. Stéphen DELCOURT</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck41" name="discoursGroupe[]" value="10" />
													<label class="custom-control-label" for="customCheck41">10. Marc MADIOT</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck42" name="discoursGroupe[]" value="11" />
													<label class="custom-control-label" for="customCheck42">11. Thibaut PINOT</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck43" name="discoursGroupe[]" value="12" />
									...
									<div class="col-md-6 col-sm-12">
										<div class="accordion">
											...
											<div class="accordion-content">
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck44" name="discoursOpinion[]" value="1" />
													<label class="custom-control-label" for="customCheck44">1. Aucun</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck45" name="discoursOpinion[]" value="2" />
													<label class="custom-control-label" for="customCheck45">2. Clients , joueurs</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck46" name="discoursOpinion[]" value="3" />
													<label class="custom-control-label" for="customCheck46">3. Gagnants</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck47" name="discoursOpinion[]" value="4" />
													<label class="custom-control-label" for="customCheck47">4. Addictologues</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck48" name="discoursOpinion[]" value="5" />
													<label class="custom-control-label" for="customCheck48">5. Buralistes</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck49" name="discoursOpinion[]" value="6" />
													<label class="custom-control-label" for="customCheck49">6. Stéphane Bern</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck50" name="discoursOpinion[]" value="7" />
													<label class="custom-control-label" for="customCheck50">7. Elus, partis politiques</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck51" name="discoursOpinion[]" value="8" />
													<label class="custom-control-label" for="customCheck51">8. Gouvernement</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck52" name="discoursOpinion[]" value="9" />
													<label class="custom-control-label" for="customCheck52">9. Concurrents</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck53" name="discoursOpinion[]" value="10" />
													<label class="custom-control-label" for="customCheck53">10. Syndicats</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck54" name="discoursOpinion[]" value="11" />
													<label class="custom-control-label" for="customCheck54">11. Analystes financiers</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck55" name="discoursOpinion[]" value="12" />
													<label class="custom-control-label" for="customCheck55">12. Partenaires</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck56" name="discoursOpinion[]" value="13" />
													<label class="custom-control-label" for="customCheck56">13. ANJ / Autorité de régulation des jeux en ligne</label>
												</div>
												<div>
													<input type="checkbox" class="custom-control-input" id="customCheck57" name="discoursOpinion[]" value="14" />
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="accordion">
											...
											<div class="accordion-content">
												<div>
													<input type="radio" id="customRadio37" name="identificationRetombee" class="custom-control-input" value="1/" />
													<label class="custom-control-label" for="customRadio37">1. Peu intéressante</label>
												</div>
												<div>
													<input type="radio" id="customRadio38" name="identificationRetombee" class="custom-control-input" value="2/" />
													<label class="custom-control-label" for="customRadio38">1. Peu intéressante</label>
												</div>
												<div>
													<input type="radio" id="customRadio39" name="identificationRetombee" class="custom-control-input" value="3/" />
													<label class="custom-control-label" for="customRadio39">1. Peu intéressante</label>
												</div>
											</div>
										</div>
