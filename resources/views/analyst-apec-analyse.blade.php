        ...
        <div class="main">
            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    ...
                    <form method="POST" action="{{ route('store_apec', ['id' => $nextId ?? $apec->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck1" name="themeDeveloppe[]" value="1" />
                                                    <label class="custom-control-label" for="customCheck1">1. Vie de l'entreprise</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck2" name="themeDeveloppe[]" value="2" />
                                                    <label class="custom-control-label" for="customCheck2">2. Dialogue social / actu emploi</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck3" name="themeDeveloppe[]" value="3" />
                                                    <label class="custom-control-label" for="customCheck3">3. Etudes de l'Aрес</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck4" name="themeDeveloppe[]" value="4" />
                                                    <label class="custom-control-label" for="customCheck4">4. Etudes autres que l'Apec</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck5" name="themeDeveloppe[]" value="5" />
                                                    <label class="custom-control-label" for="customCheck5">5. Services aux jeunes diplômés</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck6" name="themeDeveloppe[]" value="6" />
                                                    <label class="custom-control-label" for="customCheck6">6. Services aux cadres</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck7" name="themeDeveloppe[]" value="7" />
                                                    <label class="custom-control-label" for="customCheck7">7. Services aux cadres seniors</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck8" name="themeDeveloppe[]" value="8" />
                                                    <label class="custom-control-label" for="customCheck8">8. Services aux cadres demandeurs d'emploi de longue durée</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck9" name="themeDeveloppe[]" value="9" />
                                                    <label class="custom-control-label" for="customCheck9">9. Services aux entreprises</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck10" name="themeDeveloppe[]" value="10" />
                                                    <label class="custom-control-label" for="customCheck10">10. Actualités emploi</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck11" name="themeDeveloppe[]" value="11" />
                                                    <label class="custom-control-label" for="customCheck11">11. Inclusion, diversité, parité : de manière générale</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck12" name="themeDeveloppe[]" value="12" />
                                                    <label class="custom-control-label" for="customCheck12">12. Inclusion, diversité, parité : Seniors</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck13" name="themeDeveloppe[]" value="13" />
                                                    <label class="custom-control-label" for="customCheck13">13. Inclusion, diversité, parité : Inégalités F/H</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck14" name="themeDeveloppe[]" value="14" />
                                                    <label class="custom-control-label" for="customCheck14">14. Inclusion, diversité, parité : QPV</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck15" name="themeDeveloppe[]" value="15" />
                                                    <label class="custom-control-label" for="customCheck15">15. Novapec</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck16" name="themeDeveloppe[]" value="16" />
                                                    <label class="custom-control-label" for="customCheck16">16. Partenariats, participation à des événements</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck17" name="themeDeveloppe[]" value="17" />
                                                    <label class="custom-control-label" for="customCheck17">17. Organisation de salons Apec</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck18" name="themeDeveloppe[]" value="18" />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                ...
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="{{ $etude->idInputE }}" name="repriseEtude[]" value="{{ $etude->numerotationE }}" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck19" name="Representant[]" value="1" />
                                                    <label class="custom-control-label" for="customCheck19">1. Aucun</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck20" name="Representant[]" value="2" />
                                                    <label class="custom-control-label" for="customCheck20">2. Gaël Bouron, Responsable Adjoint pôle Etudes</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck21" name="Representant[]" value="3" />
                                                    <label class="custom-control-label" for="customCheck21">3. Indira Camalon, responsable La Réunion - Mayotte</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck22" name="Representant[]" value="4" />
                                                    <label class="custom-control-label" for="customCheck22">4. Christian Clémencelle, Vice-Président CA</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck23" name="Representant[]" value="5" />
                                                    <label class="custom-control-label" for="customCheck23">5. Marie-Laure Collet, Vice-Présidente CA</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck24" name="Representant[]" value="6" />
                                                    <label class="custom-control-label" for="customCheck24">6. Pierre Damiani, Président CA</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck25" name="Representant[]" value="7" />
                                                    <label class="custom-control-label" for="customCheck25">7. Véronique Dubois, Directrice de la communication</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck26" name="Representant[]" value="8" />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck52" name="relaisOpinion[]" value="1" />
                                                    <label class="custom-control-label" for="customCheck52">1. Aucun</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck53" name="relaisOpinion[]" value="2" />
                                                    <label class="custom-control-label" for="customCheck53">2. Demandeurs d'emploi</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck54" name="relaisOpinion[]" value="3" />
                                                    <label class="custom-control-label" for="customCheck54">3. Jeunes diplômés</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck55" name="relaisOpinion[]" value="4" />
                                                    <label class="custom-control-label" for="customCheck55">4. Cadres salariés</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck56" name="relaisOpinion[]" value="5" />
                                                    <label class="custom-control-label" for="customCheck56">5. Membres d'entreprises conseillées par l'Apec</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck57" name="relaisOpinion[]" value="6" />
                                                    <label class="custom-control-label" for="customCheck57">6. Partenaires / écosystème emploi formation / écoles</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck58" name="relaisOpinion[]" value="7" />
                                                    <label class="custom-control-label" for="customCheck58">7. Pouvoirs publics</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck59" name="relaisOpinion[]" value="8" />
                                                    <label class="custom-control-label" for="customCheck59">8. Julie Langlade, Resp. programme NOVAPEC</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck60" name="relaisOpinion[]" value="9" />
                                                    <label class="custom-control-label" for="customCheck60">9. Publics bénéficiaires du programme NOVAPEC</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck61" name="relaisOpinion[]" value="10" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="radio" id="customRadio44" name="teneurArticle" class="custom-control-input" value="1/" />
                                                    <label class="custom-control-label" for="customRadio44">1. Favorable</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio45" name="teneurArticle" class="custom-control-input" value="2/" />
                                                    <label class="custom-control-label" for="customRadio45">2. Neutre</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio46" name="teneurArticle" class="custom-control-input" value="3/" />
                                                    <label class="custom-control-label" for="customRadio46">3. Mitigée</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio47" name="teneurArticle" class="custom-control-input" value="4/" />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck62" name="repriseMessage[]" value="1" />
                                                    <label class="custom-control-label" for="customCheck62">1. Aucun</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck63" name="repriseMessage[]" value="2" />
                                                    <label class="custom-control-label" for="customCheck63">2. L'Apec, un acteur engagé et mobilisé</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck64" name="repriseMessage[]" value="3" />
                                                    <label class="custom-control-label" for="customCheck64">3. L'Apec anticipe le monde du travail de demain</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck65" name="repriseMessage[]" value="4" />
                                                    <label class="custom-control-label" for="customCheck65">4. L'Apec accompagne les cadres / jeunes diplômés toute leur vie</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck66" name="repriseMessage[]" value="5" />
                                                    <label class="custom-control-label" for="customCheck66">5. L'Apec aide à la réussite des recrutements des entreprises</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck67" name="repriseMessage[]" value="6" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="radio" id="customRadio48" name="epaisseurMediatique" class="custom-control-input" value="1/" />
                                                    <label class="custom-control-label" for="customRadio48">1. Sujet principal</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio49" name="epaisseurMediatique" class="custom-control-input" value="2/" />
                                                    <label class="custom-control-label" for="customRadio49">2. Sujet secondaire</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio50" name="epaisseurMediatique" class="custom-control-input" value="3/" />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="actualiteRetombee" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="radio" id="customRadio51" name="identificationRetombee" class="custom-control-input" value="1/" />
                                                    <label class="custom-control-label" for="customRadio51">1. Peu intéressante</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio52" name="identificationRetombee" class="custom-control-input" value="2/" />
                                                    <label class="custom-control-label" for="customRadio52">2. Plutôt intéressante</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio53" name="identificationRetombee" class="custom-control-input" value="3/" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="gillesGateau" />
                                            @error('gillesGateau')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
