            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    ...
                    <div style="background-color: whitesmoke; text-align :center;">
                        <h1>Formulaire d'analyse LHG</h1>
                    </div>

                    <br>

                    <form method="POST" action="{{ url('store_servier') }}" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck1" name="citation[]" value="1" {{ in_array('1', explode('/', $data->citation)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck1">1. Servier / Gouvernance</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck2" name="citation[]" value="2" {{ in_array('2', explode('/', $data->citation)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck2">2. Biogaran</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck3" name="citation[]" value="3" {{ in_array('3', explode('/', $data->citation)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck3">3. Oril Industrie</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck4" name="citation[]" value="4" {{ in_array('4', explode('/', $data->citation)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck4">4. Laboratoires Servier Industrie</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck5" name="citation[]" value="5" {{ in_array('5', explode('/', $data->citation)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck5">5. Mediator</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck6" name="citation[]" value="6" {{ in_array('6', explode('/', $data->citation)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck6">6. Autre</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck7" name="citation[]" value="7" {{ in_array('7', explode('/', $data->citation)) ? 'checked' : '' }} />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="radio" id="customRadio1" name="typePresse" class="custom-control-input" value="1/" {{ $data->typePresse == '1/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio1">1. Print</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio2" name="typePresse" class="custom-control-input" value="2/" {{ $data->typePresse == '2/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio2">2. Online</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio3" name="typePresse" class="custom-control-input" value="3/" {{ $data->typePresse == '3/' ? 'checked' : '' }} />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="radio" id="customRadio4" name="famillePresse" class="custom-control-input" value="1/" {{ $data->famillePresse == '1/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio4">1. Agence de presse</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio5" name="famillePresse" class="custom-control-input" value="2/" {{ $data->famillePresse == '2/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio5">2. PQN</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio6" name="famillePresse" class="custom-control-input" value="3/" {{ $data->famillePresse == '3/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio6">3. PQR</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio7" name="famillePresse" class="custom-control-input" value="4/" {{ $data->famillePresse == '4/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio7">4. Presse économique et financière</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio8" name="famillePresse" class="custom-control-input" value="5/" {{ $data->famillePresse == '5/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio8">5. Presse métier</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio9" name="famillePresse" class="custom-control-input" value="6/" {{ $data->famillePresse == '6/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio9">6. Autres presses sectorielles</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio10" name="famillePresse" class="custom-control-input" value="7/" {{ $data->famillePresse == '7/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio10">7. News-Hebdos</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio11" name="famillePresse" class="custom-control-input" value="8/" {{ $data->famillePresse == '8/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio11">8. Presse grand public</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio12" name="famillePresse" class="custom-control-input" value="9/" {{ $data->famillePresse == '9/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio12">9. TV-Radios</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio13" name="famillePresse" class="custom-control-input" value="10/" {{ $data->famillePresse == '10/' ? 'checked' : '' }} />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="radio" id="customRadio14" name="tonalite" class="custom-control-input" value="1/" {{ $data->tonalite == '1/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio14">1. Factuelle</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio15" name="tonalite" class="custom-control-input" value="2/" {{ $data->tonalite == '2/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio15">2. Favorable</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio16" name="tonalite" class="custom-control-input" value="3/" {{ $data->tonalite == '3/' ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customRadio16">3. Mitigée</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="customRadio17" name="tonalite" class="custom-control-input" value="4/" {{ $data->tonalite == '4/' ? 'checked' : '' }} />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck8" name="attributImage[]" value="1" {{ in_array('1', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck8">1. Aucun</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck9" name="attributImage[]" value="2" {{ in_array('2', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck9">2. Groupe en transformation</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck10" name="attributImage[]" value="3" {{ in_array('3', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck10">3. Groupe Indépendant gouverné par une Fondation</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck11" name="attributImage[]" value="4" {{ in_array('4', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck11">4. Groupe International</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck12" name="attributImage[]" value="5" {{ in_array('5', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck12">5. Groupe Engagé</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck13" name="attributImage[]" value="6" {{ in_array('6', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck13">6. Groupe Innovant</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck14" name="attributImage[]" value="7" {{ in_array('7', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck14">7. Leader du cardio-métabolisme</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck15" name="attributImage[]" value="8" {{ in_array('8', explode('/', $data->attributImage)) ? 'checked' : '' }} />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck16" name="theme[]" value="1" {{ in_array('1', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck16">1. Stratégie et Transformation</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck17" name="theme[]" value="2" {{ in_array('2', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck17">2. Partenariats</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck18" name="theme[]" value="3" {{ in_array('3', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck18">3. Gouvernance, nominations</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck19" name="theme[]" value="4" {{ in_array('4', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck19">4. Actualités financières</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck20" name="theme[]" value="5" {{ in_array('5', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck20">5. R & D</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck21" name="theme[]" value="6" {{ in_array('6', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck21">6. Production, Fabrication</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck22" name="theme[]" value="7" {{ in_array('7', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck22">7. Bioproduction</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck23" name="theme[]" value="8" {{ in_array('8', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck23">8. Lancements de médicaments</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck24" name="theme[]" value="9" {{ in_array('9', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck24">9. Actualités Produits</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck25" name="theme[]" value="10" {{ in_array('10', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck25">10. Actualités Marché du secteur pharmaceutique</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck26" name="theme[]" value="11" {{ in_array('11', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck26">11. Stratégie RH</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck27" name="theme[]" value="12" {{ in_array('12', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck27">12. Social RH</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck28" name="theme[]" value="13" {{ in_array('13', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck28">13. Développement Durable</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck29" name="theme[]" value="14" {{ in_array('14', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck29">14. Actions solidaires/Mécénat Servier</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck30" name="theme[]" value="15" {{ in_array('15', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck30">15. Affaire Mediator</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck31" name="theme[]" value="16" {{ in_array('16', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck31">16. Autres Litiges, Affaires et Controverses</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck32" name="theme[]" value="17" {{ in_array('17', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck32">17. Faits divers</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck33" name="theme[]" value="18" {{ in_array('18', explode('/', $data->theme)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck33">18. Autre thème</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck34" name="theme[]" value="19" {{ in_array('19', explode('/', $data->theme)) ? 'checked' : '' }} />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck95" name="paroleRepresentant[]" value="1" {{ in_array('1', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck95">1. Aucun</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck96" name="paroleRepresentant[]" value="2" {{ in_array('2', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck96">2. Autres porte-parole</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck97" name="paroleRepresentant[]" value="3" {{ in_array('3', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck97">3. Non précisé | Sources off</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck98" name="paroleRepresentant[]" value="4" {{ in_array('4', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck98">4. Claude BERTRAND, Directeur Général de la R & D</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck99" name="paroleRepresentant[]" value="5" {{ in_array('5', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck99">5. Pascal BRIERE, Vice-Président Exécutif Activités Génériques</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck100" name="paroleRepresentant[]" value="6" {{ in_array('6', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck100">6. Damien CATOIR Vice-Président Exécutif Secrétaire Général</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck101" name="paroleRepresentant[]" value="7" {{ in_array('7', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck101">7. Virginie DOMINGUEZ, Vice-Présidente Exécutive Digital, Data & SI</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck102" name="paroleRepresentant[]" value="8" {{ in_array('8', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                ...
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck103" name="paroleRepresentant[]" value="9" {{ in_array('9', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck103">9. David HINDLEY, Vice-Président Exécutif RH</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck104" name="paroleRepresentant[]" value="10" {{ in_array('10', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck104">10. Siham IMANI, Vice-Présidente Exécutive Corporate Strategy</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck105" name="paroleRepresentant[]" value="11" {{ in_array('11', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck105">11. Arnaud LALLOUETTE Vice-Président Exécutif Global Medical</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck106" name="paroleRepresentant[]" value="12" {{ in_array('12', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck106">12. Olivier LAUREAU, Président</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck107" name="paroleRepresentant[]" value="13" {{ in_array('13', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck107">13. Pascal LEMAIRE, Vice-Président Exécutif Finance</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck108" name="paroleRepresentant[]" value="14" {{ in_array('14', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck108">14. STEPHANE MASCARAU, Vice-Président Exécutif Opérations Monde</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck109" name="paroleRepresentant[]" value="15" {{ in_array('15', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck109">15. Pierre VENESQUE, Vice-Président Exécutif Industrie</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck110" name="paroleRepresentant[]" value="16" {{ in_array('16', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck110">16. Porte-parole Biogaran</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck111" name="paroleRepresentant[]" value="17" {{ in_array('17', explode('/', $data->paroleRepresentant)) ? 'checked' : '' }} />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="autreRepresentant" value="{{ $data->autreRepresentant }}" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-content">
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck112" name="paroleOpinion[]" value="1" {{ in_array('1', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck112">1. Aucun</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck113" name="paroleOpinion[]" value="2" {{ in_array('2', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck113">2. Autre relais d’opinion</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck114" name="paroleOpinion[]" value="3" {{ in_array('3', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck114">3. Irène FRACHON, médecin, lanceur d’alerte (Mediator)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck115" name="paroleOpinion[]" value="4" {{ in_array('4', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck115">4. Partenaires commerciaux, fournisseurs…</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck116" name="paroleOpinion[]" value="5" {{ in_array('5', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck116">5. Concurrents</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck117" name="paroleOpinion[]" value="6" {{ in_array('6', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                ...
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck118" name="paroleOpinion[]" value="7" {{ in_array('7', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck118">7. Responsables politiques (Ministres…)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck119" name="paroleOpinion[]" value="8" {{ in_array('8', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck119">8. Professionnels de Santé</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck120" name="paroleOpinion[]" value="9" {{ in_array('9', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck120">9. CNAM (Caisse Nationale d’Assurance Maladie)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck121" name="paroleOpinion[]" value="10" {{ in_array('10', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck121">10. EMA (Agence Européenne du Médicament)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck122" name="paroleOpinion[]" value="11" {{ in_array('11', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                ...
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck123" name="paroleOpinion[]" value="12" {{ in_array('12', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck123">12. ANSM (Agence Sécurité du Médicament et des Produits de Santé)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck124" name="paroleOpinion[]" value="13" {{ in_array('13', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck124">13. LEEM (Les Entreprises du Médicament)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck125" name="paroleOpinion[]" value="14" {{ in_array('14', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                ...
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck126" name="paroleOpinion[]" value="15" {{ in_array('15', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck126">15. G5 Santé (Ipsen, LFB, Pierre Fabre, Sanofi, Servier et Théa)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck127" name="paroleOpinion[]" value="16" {{ in_array('16', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                ...
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck128" name="paroleOpinion[]" value="17" {{ in_array('17', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck128">17. Avocats des victimes du Mediator (Charles Joseph- Oudin…)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck129" name="paroleOpinion[]" value="18" {{ in_array('18', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                                    <label class="custom-control-label" for="customCheck129">18. Autres patients ou associations de patients (hors Mediator)</label>
                                                </div>
                                                <div>
                                                    <input type="checkbox" class="custom-control-input" id="customCheck130" name="paroleOpinion[]" value="19" {{ in_array('19', explode('/', $data->paroleOpinion)) ? 'checked' : '' }} />
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="autreOpinion" value="{{ $data->autreOpinion }}" />
                                            @error('autreOpinion')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="actualite" value="{{ $data->actualite }}" />
                                            @error('actualite')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
