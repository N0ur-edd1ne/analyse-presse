            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    ...
                    <div style="background-color: whitesmoke; text-align :center;">
                        <h1>Modification des détails du Communiqué de Presse</h1>
                    </div>

                    <form action="{{ route('communiques.update', $communique->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="pd-20 bg-white border-radius-4 box-shadow mb-0">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="name">Numéro du CP</label>
                                    <input type="text" name="numerotationC" class="form-control" value="{{ $communique->numerotationC }}" />
                                ...
                                <div class="form-group">
                                    <label for="name">Idientifiant du CP</label>
                                    <input type="text" name="idInputC" class="form-control" value="{{ $communique->idInputC }}" />
                                ...
                                <div class="form-group">
                                    <label for="name">Libellé du CP</label>
                                    <input type="text" name="libelleC" class="form-control" value="{{ $communique->libelleC }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="etudeAssocieeC" id="etudeAssocieeC" class="form-control" value="{{ $communique->etudeAssocieeC }}">
                                        <option value="" disabled selected>Choisir l'étude</option>
                                        <option value="APEC">APEC</option>
                                        <option value="Louvre Hotel Group">LOUVRE HOTELS GROUP</option>
                                        <option value="Allianz France">ALLIANZ FRANCE</option>
                                        <option value="Servier">SERVIER</option>
                                    </select>
                                    @error('etudeAssocieeC')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
