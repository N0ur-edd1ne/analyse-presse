            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    ...
                    <div style="background-color: whitesmoke; text-align :center;">
                        <h1>Nouveau Communiqué de Presse</h1>
                    </div>
                    ...
                    <form action="{{ route('communiques.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="numerotationC" class="form-control" />
                            @error('numerotationC')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="idInputC" class="form-control" />
                            @error('idInputC')
                            <span class="text-danger"> {{ $message }} </span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="libelleC" class="form-control" />
                            @error('libelleC')
                            <span class="text-danger"> {{ $message }} </span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="name">Etudes Associées</label>
                            <select name="etudeAssocieeC" id="etudeAssocieeC" class="form-control">
                        ...
                        <button type="submit" class="btn btn-primary mt-3 px-4">Ajouter</button>
