            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    ...
                    <div style="background-color: whitesmoke; text-align :center;">
                        <h1>Affichage des détails du Communiqué de Presse</h1>
                    </div>
                        ...
                        <table style="width: 100%; text-align: center; border-collapse: collapse;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-weight: bold; border: 1px solid black;">Identifiant du CP</th>
                                    <th style="font-weight: bold; border: 1px solid black;">Libellé du CP</th>
                                    <th style="font-weight: bold; border: 1px solid black;">Etudes Associées</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td style="border: 1px solid black;">{{ $communique->numerotationC }}</td>
                                    <td style="border: 1px solid black;">{{ $communique->idInputC }}</td>
                                    <td style="border: 1px solid black;">{{ $communique->libelleC }}</td>
                                    <td style="border: 1px solid black;">{{ $communique->etudeAssocieeC }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
